...
document.addEventListener("DOMContentLoaded", function () {
    ...
    signupForm.addEventListener("submit", function (event) { return __awaiter(_this, void 0, void 0, function () {
        var name, email, password, confirmPassword, address, phone, website, company, role, addressParts, newUser, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    website = document.getElementById("signupWebsite").value.trim();
                    ...
                    addressParts = address.split(",").map(function (part) { return part.trim(); });
                    ...
                    newUser = {
                        name: name,
                        email: email,
                        password: password, // Add any hashing logic here if needed
                        address: {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, fetch("http://localhost:3000/employees", {
                            method: "POST",
